...
type CategoryServiceClient interface {
	CreateCategoryResponse(ctx context.Context, in *CreateCategoryRequest, opts ...grpc.CallOption) (*CategoryResponse, error)
...
func (c *categoryServiceClient) CreateCategoryResponse(ctx context.Context, in *CreateCategoryRequest, opts ...grpc.CallOption) (*CategoryResponse, error) {
	out := new(CategoryResponse)
	err := c.cc.Invoke(ctx, "/pb.CategoryService/CreateCategoryResponse", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CategoryServiceServer interface {
	CreateCategoryResponse(context.Context, *CreateCategoryRequest) (*CategoryResponse, error)
...
func (UnimplementedCategoryServiceServer) CreateCategoryResponse(context.Context, *CreateCategoryRequest) (*CategoryResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateCategoryResponse not implemented")
}
...
func _CategoryService_CreateCategoryResponse_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateCategoryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CategoryServiceServer).CreateCategoryResponse(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.CategoryService/CreateCategoryResponse",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).CreateCategoryResponse(ctx, req.(*CreateCategoryRequest))
	}
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "CreateCategoryResponse",
			Handler:    _CategoryService_CreateCategoryResponse_Handler,
		},
		{
